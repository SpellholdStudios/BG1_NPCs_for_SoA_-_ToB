...
=
@53 
IF ~~ THEN DO ~RevealAreaOnMap("AR1700")AddJournalEntry(@1799,QUEST)~EXIT
END
END
...
=
@55 
IF ~~ THEN REPLY @56 GOTO airshipQUEST5c
...
=
@64 
IF ~NumItemsPartyGT("Platnum",299)PartyHasItem("bgsx09")~ THEN REPLY @65 GOTO airshipQUESTDONE1
...
SAY @67 
IF ~~ THEN DO ~TakePartyItemNum("Platnum",300)TakePartyItem("bgsx09")DestroyItem("Platnum")DestroyItem("bgsx09")
...
SAY @68 
IF ~~ THEN DO ~EraseJournalEntry(@1799)AddJournalEntry(@1800,QUEST_DONE)AddExperienceParty(7500)~ EXIT
END
END
